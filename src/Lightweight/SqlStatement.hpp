...
class [[nodiscard]] SqlStatement final: public SqlDataBinderCallback
{
  ...
  private:
    ...
    ///
    /// @param cache The cache to park in and take from, already known to be usable.
    ...
    /// @copydoc ReleasePreparedHandle()
    /// @param cache The cache to park in, already known to be usable.
    bool ReleasePreparedHandle(SqlPreparedStatementCache& cache) noexcept;
