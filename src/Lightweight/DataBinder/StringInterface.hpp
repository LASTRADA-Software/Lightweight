...
concept SqlStringInterface =
    requires(S s, S const cs, std::size_t n, S::value_type ch, std::basic_string_view<typename S::value_type> sv) {
        /* =========================
           Associated types
           ========================= */
        ...
        /* =========================
           ...
           ========================= */
        { cs.substr() } -> std::same_as<std::basic_string_view<typename S::value_type>>;

        { cs.str() } -> std::same_as<std::basic_string_view<typename S::value_type>>;

        { cs.ToString() } -> std::same_as<std::basic_string<typename S::value_type>>;

        { cs.ToStringView() } -> std::same_as<std::basic_string_view<typename S::value_type>>;
