...
struct Table23 final
{
    static constexpr std::string_view TableName = "table_23";
    ...
    Light::Field<Light::SqlDateTime, Light::SqlRealName { "col_33" }> col33;
    ...
    Light::Field<std::optional<int32_t>, Light::SqlRealName { "col_37" }> col37;
    ...
    Light::Field<int32_t, Light::SqlRealName { "col_45" }> col45;
    Light::Field<bool, Light::SqlRealName { "col_46" }> col46;
    Light::Field<bool, Light::SqlRealName { "col_47" }> col47;
