...
struct Table17 final
{
    static constexpr std::string_view TableName = "table_17";
    ...
    Light::Field<std::optional<Light::SqlAnsiString<50>>, Light::SqlRealName { "col_24" }> col24;
    ...
    Light::Field<std::optional<bool>, Light::SqlRealName { "col_30" }> col30;
