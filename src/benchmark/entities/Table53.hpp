...
struct Table53 final
{
    ...
    Light::Field<int32_t, Light::SqlRealName { "col_26" }> col26;
    ...
    Light::Field<std::optional<int32_t>, Light::SqlRealName { "col_34" }> col34;
    ...
    Light::Field<Light::SqlTime, Light::SqlRealName { "col_38" }> col38;
    ...
    Light::Field<std::optional<Light::SqlDynamicAnsiString<0>>, Light::SqlRealName { "col_44" }> col44;
    Light::Field<double, Light::SqlRealName { "col_45" }> col45;
    Light::Field<std::optional<Light::SqlDateTime>, Light::SqlRealName { "col_46" }> col46;
    Light::Field<Light::SqlTime, Light::SqlRealName { "col_47" }> col47;
    Light::Field<bool, Light::SqlRealName { "col_48" }> col48;
    Light::Field<Light::SqlTime, Light::SqlRealName { "col_49" }> col49;
