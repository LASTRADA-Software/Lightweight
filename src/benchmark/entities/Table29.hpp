...
struct Table29 final
{
    ...
    Light::Field<std::optional<int32_t>, Light::SqlRealName { "col_26" }> col26;
    ...
    Light::Field<bool, Light::SqlRealName { "col_34" }> col34;
    ...
    Light::Field<Light::SqlDynamicAnsiString<0>, Light::SqlRealName { "col_38" }> col38;
    ...
    Light::Field<Light::SqlTime, Light::SqlRealName { "col_43" }> col43;
    Light::Field<double, Light::SqlRealName { "col_44" }> col44;
    Light::Field<std::optional<Light::SqlAnsiString<50>>, Light::SqlRealName { "col_45" }> col45;
    Light::Field<double, Light::SqlRealName { "col_46" }> col46;
