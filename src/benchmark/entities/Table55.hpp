...
struct Table55 final
{
    ...
    Light::Field<Light::SqlTime, Light::SqlRealName { "col_23" }> col23;
    ...
    Light::Field<std::optional<int32_t>, Light::SqlRealName { "col_31" }> col31;
    ...
    Light::Field<Light::SqlAnsiString<50>, Light::SqlRealName { "col_38" }> col38;
