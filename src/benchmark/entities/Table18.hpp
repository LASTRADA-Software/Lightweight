...
struct Table18 final
{
    static constexpr std::string_view TableName = "table_18";
    ...
    Light::Field<bool, Light::SqlRealName { "col_38" }> col38;
    ...
    Light::Field<Light::SqlTime, Light::SqlRealName { "col_41" }> col41;
