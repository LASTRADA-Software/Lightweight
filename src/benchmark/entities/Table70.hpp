...
struct Table70 final
{
    ...
    Light::Field<Light::SqlDateTime, Light::SqlRealName { "col_23" }> col23;
    ...
    Light::Field<Light::SqlDate, Light::SqlRealName { "col_39" }> col39;
    ...
    Light::Field<std::optional<bool>, Light::SqlRealName { "col_45" }> col45;
