...
struct Table10 final
{
    static constexpr std::string_view TableName = "table_10";
    ...
    Light::Field<Light::SqlDate, Light::SqlRealName { "col_31" }> col31;
    ...
    Light::Field<Light::SqlDate, Light::SqlRealName { "col_36" }> col36;
    Light::Field<std::optional<Light::SqlDateTime>, Light::SqlRealName { "col_37" }> col37;
    Light::Field<Light::SqlDate, Light::SqlRealName { "col_38" }> col38;
    Light::Field<std::optional<Light::SqlAnsiString<50>>, Light::SqlRealName { "col_39" }> col39;
    ...
    Light::Field<int32_t, Light::SqlRealName { "col_42" }> col42;
