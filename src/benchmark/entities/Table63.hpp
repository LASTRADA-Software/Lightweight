...
struct Table63 final
{
    static constexpr std::string_view TableName = "table_63";
    ...
    Light::Field<std::optional<Light::SqlDate>, Light::SqlRealName { "col_28" }> col28;
    Light::Field<std::optional<int32_t>, Light::SqlRealName { "col_29" }> col29;
    Light::Field<bool, Light::SqlRealName { "col_30" }> col30;
    ...
    Light::Field<std::optional<Light::SqlDateTime>, Light::SqlRealName { "col_37" }> col37;
    ...
    Light::Field<Light::SqlDateTime, Light::SqlRealName { "col_41" }> col41;
    ...
    Light::Field<std::optional<Light::SqlDate>, Light::SqlRealName { "col_46" }> col46;
    Light::Field<Light::SqlTime, Light::SqlRealName { "col_47" }> col47;
    Light::Field<std::optional<double>, Light::SqlRealName { "col_48" }> col48;
