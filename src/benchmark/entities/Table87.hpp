...
struct Table87 final
{
    ...
    Light::Field<Light::SqlDate, Light::SqlRealName { "col_41" }> col41;
    ...
    Light::Field<std::optional<int32_t>, Light::SqlRealName { "col_45" }> col45;
    Light::Field<bool, Light::SqlRealName { "col_46" }> col46;
    Light::Field<std::optional<Light::SqlAnsiString<50>>, Light::SqlRealName { "col_47" }> col47;
