...
struct Table14 final
{
    static constexpr std::string_view TableName = "table_14";
    ...
    Light::Field<bool, Light::SqlRealName { "col_14" }> col14;
    ...
    Light::Field<std::optional<Light::SqlDateTime>, Light::SqlRealName { "col_21" }> col21;
    ...
    Light::Field<std::optional<double>, Light::SqlRealName { "col_34" }> col34;
    Light::Field<std::optional<double>, Light::SqlRealName { "col_35" }> col35;
    Light::Field<double, Light::SqlRealName { "col_36" }> col36;
    Light::Field<std::optional<Light::SqlDate>, Light::SqlRealName { "col_37" }> col37;
    ...
    Light::Field<std::optional<Light::SqlTime>, Light::SqlRealName { "col_41" }> col41;
    ...
    Light::Field<std::optional<Light::SqlAnsiString<50>>, Light::SqlRealName { "col_44" }> col44;
    Light::Field<double, Light::SqlRealName { "col_45" }> col45;
    Light::Field<Light::SqlDateTime, Light::SqlRealName { "col_46" }> col46;
