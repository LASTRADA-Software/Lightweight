...
struct Table5 final
{
    static constexpr std::string_view TableName = "table_5";
    ...
    Light::Field<bool, Light::SqlRealName { "col_40" }> col40;
    Light::Field<std::optional<int32_t>, Light::SqlRealName { "col_41" }> col41;
    ...
    Light::Field<bool, Light::SqlRealName { "col_45" }> col45;
