...
struct Table19 final
{
    static constexpr std::string_view TableName = "table_19";
    ...
    Light::Field<std::optional<Light::SqlDynamicAnsiString<0>>, Light::SqlRealName { "col_29" }> col29;
    Light::Field<int32_t, Light::SqlRealName { "col_30" }> col30;
    ...
    Light::Field<double, Light::SqlRealName { "col_39" }> col39;
    Light::Field<std::optional<bool>, Light::SqlRealName { "col_40" }> col40;
    Light::Field<std::optional<bool>, Light::SqlRealName { "col_41" }> col41;
    Light::Field<std::optional<bool>, Light::SqlRealName { "col_42" }> col42;
    Light::Field<bool, Light::SqlRealName { "col_43" }> col43;
    Light::Field<Light::SqlDynamicAnsiString<0>, Light::SqlRealName { "col_44" }> col44;
    Light::Field<std::optional<Light::SqlAnsiString<50>>, Light::SqlRealName { "col_45" }> col45;
    Light::Field<Light::SqlTime, Light::SqlRealName { "col_46" }> col46;
