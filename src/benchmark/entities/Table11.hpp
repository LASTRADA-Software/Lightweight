...
struct Table11 final
{
    static constexpr std::string_view TableName = "table_11";
    ...
    Light::Field<bool, Light::SqlRealName { "col_21" }> col21;
    ...
    Light::Field<Light::SqlTime, Light::SqlRealName { "col_24" }> col24;
