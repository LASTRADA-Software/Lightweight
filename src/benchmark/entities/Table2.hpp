...
struct Table2 final
{
    static constexpr std::string_view TableName = "table_2";
    ...
    Light::Field<std::optional<Light::SqlDateTime>, Light::SqlRealName { "col_30" }> col30;
    Light::Field<std::optional<bool>, Light::SqlRealName { "col_31" }> col31;
