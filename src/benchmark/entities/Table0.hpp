...
struct Table0 final
{
    static constexpr std::string_view TableName = "table_0";
    ...
    Light::Field<Light::SqlDateTime, Light::SqlRealName { "col_44" }> col44;
    ...
    Light::Field<std::optional<int32_t>, Light::SqlRealName { "col_47" }> col47;
};
