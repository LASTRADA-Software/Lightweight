...
struct Table94 final
{
    ...
    Light::Field<std::optional<int32_t>, Light::SqlRealName { "col_32" }> col32;
    ...
    Light::Field<int32_t, Light::SqlRealName { "col_41" }> col41;
    ...
    Light::Field<std::optional<Light::SqlDate>, Light::SqlRealName { "col_44" }> col44;
    Light::Field<Light::SqlAnsiString<50>, Light::SqlRealName { "col_45" }> col45;
    Light::Field<Light::SqlDate, Light::SqlRealName { "col_46" }> col46;
    Light::Field<Light::SqlAnsiString<50>, Light::SqlRealName { "col_47" }> col47;
    Light::Field<std::optional<int32_t>, Light::SqlRealName { "col_48" }> col48;
    Light::Field<double, Light::SqlRealName { "col_49" }> col49;
