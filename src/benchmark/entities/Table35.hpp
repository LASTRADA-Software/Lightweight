...
struct Table35 final
{
    ...
    Light::Field<std::optional<Light::SqlDate>, Light::SqlRealName { "col_12" }> col12;
    ...
    Light::Field<Light::SqlDate, Light::SqlRealName { "col_19" }> col19;
    ...
    Light::Field<Light::SqlDateTime, Light::SqlRealName { "col_39" }> col39;
    Light::Field<Light::SqlAnsiString<50>, Light::SqlRealName { "col_40" }> col40;
    Light::Field<double, Light::SqlRealName { "col_41" }> col41;
