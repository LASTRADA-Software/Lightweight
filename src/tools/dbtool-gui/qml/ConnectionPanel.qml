            ...
            Repeater {
                model: [
                    { key: "profile", label: qsTr("Profile"),
                      tip: qsTr("Connect via a named entry in the Lightweight profile YAML.") },
                    { key: "dsn",     label: qsTr("DSN"),
                      tip: qsTr("Connect via a system-registered ODBC Data Source Name.") },
                    { key: "custom",  label: qsTr("Custom"),
                      tip: qsTr("Connect with a raw ODBC connection string.") },
                ]
                Rectangle {
        ...
        Column {
            ...
            Row {
                ...
                Button {
                    ...
                    ToolTip.delay: 500
                    ToolTip.timeout: 10000
                    ToolTip.text: qsTr("Re-enumerate ODBC Data Sources.")
