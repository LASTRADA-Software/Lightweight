...
[[nodiscard]] std::vector<std::vector<CodeBlock>> GroupBlocksByLineBudget(std::vector<CodeBlock> const& blocks,
...
[[nodiscard]] WriteResult EmitChunked(std::filesystem::path const& outputPath,
