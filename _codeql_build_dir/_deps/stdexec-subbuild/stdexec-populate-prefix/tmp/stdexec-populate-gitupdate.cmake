...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "nvhpc-24.09.rc1"
  WORKING_DIRECTORY "/home/runner/work/Lightweight/Lightweight/_codeql_build_dir/_deps/stdexec-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "nvhpc-24.09.rc1")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("nvhpc-24.09.rc1" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: nvhpc-24.09.rc1")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/nvhpc-24.09.rc1")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"nvhpc-24.09.rc1\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/runner/work/Lightweight/Lightweight/_codeql_build_dir/_deps/stdexec-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/runner/work/Lightweight/Lightweight/_codeql_build_dir/_deps/stdexec-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
